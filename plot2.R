...
# This is the R Code for plot 2 in Project 1
...
# Draw the line plot using the Global_active_power column
plot(energy_data$DateTime, energy_data$Global_active_power, type="l", xlab = "", ylab="Global Active Power (kilowatts)")

# Close the png device
dev.off()
######### END OF CODE FOR PLOT2 #################################